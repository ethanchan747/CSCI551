...
int routeNkeyorder_setup(deque<int> &next_router, deque<unsigned char *> &keyorder, int routnum10, unsigned char rk1[16],unsigned char rk2[16],unsigned char rk3[16],unsigned char rk4[16],unsigned char rk5[16],unsigned char rk6[16]){ //create route order, generates 6 keys, and assignes them in their order.
...
int circuit_setup(int routernum10, struct sockaddr_in &their_addr1, struct sockaddr_in &their_addr2, struct sockaddr_in &their_addr3,struct sockaddr_in &their_addr4, struct sockaddr_in &their_addr5, struct sockaddr_in &their_addr6, deque<int> &next_router,deque<unsigned char *> &keyorder, int hops,int sockfd){
