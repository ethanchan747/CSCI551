                        ...
                        if(minitorbuf[0] == 0x65){
                            ...
                            if(it != cidnext.end() ){ // should be good
                                ...
                                */
                                ...
                                mykey = keylookup[host & 0x0011]; //Stage8
                                ...
                                keylookup[host & 0x0011] = mykey; //Stage 8
                                    ...
                                    if(protocol == IPPROTO_ICMP){
                                        ...
                                        if(((a == e) && (b == f) && (c == g))){   // open brackets this means that this ICMP message is directed to eth1's network
                                            ...
                                            if(!flag3){
                                                ...
                                                nextflow->circuit_num = host & 0x0011;
                    ...
                    */
                    ...
                    if(((a == e) && (b == f) && (c == g))){
                        ...
                        //tun_utype = 0;
                            ...
                            if(!flag3){
                                cout << "ERROR: no known circuit to relay packet" << endl;
                                return 1;
                            }
